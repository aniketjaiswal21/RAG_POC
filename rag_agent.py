...
def update_retriever():
    ...
    retriever_tool = create_retriever_tool(
        ...
        "Search and Retrieve Information From Legal Documents.",
    )
    # ---------------------------------
    ...
    def agent(state):
        ...
        Indian Case Laws. Your role is to provide detailed, accurate, and helpful answers \
        to user questions by referring to information from case law manuals. \
        Respond in a clear and professional tone, ensuring your explanations are easy to \
        understand while providing all necessary details.
        """
